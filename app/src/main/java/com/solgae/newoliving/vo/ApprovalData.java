...
public class ApprovalData {
    ...
    public ApprovalData(String TRAN_NO, String TRAN_TYPE, String TERMINAL_TYPE, String TEXT_DECLINE, String TOTAL_AMOUNT, String TAX,
                        String TAX_OPTION, String TIP, String TIP_OPTION, String APPROVAL_NUM, String APPROVAL_DATE, String TRAN_SERIALNO,
                        String CASHAMOUNT, String INSTALLMENT, String PRINT_DATA, String ADD_FIELD, String SIGN_FLAG, String TIMEOUT, String TEXT_PROCESS,
                        String TEXT_COMPLETE, String COLUMM_NO, String SHOP_TID, String SHOP_BIZ_NUM, String discount) {
    ...
    public String getSIGN_FLAG() { return SIGN_FLAG; }

    public void setSIGN_FLAG(String SIGN_FLAG) { this.SIGN_FLAG = SIGN_FLAG; }
}
