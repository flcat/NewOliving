...
public class AndExoPlayerView extends LinearLayout implements View.OnClickListener {
    ...
    public static MessageEventListener mMessageListener;
    ...
    public class ComponentListener implements Player.EventListener {
        ...
        public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
            ...
            mMessageListener.onMessageEventListener(stateString);
    ...
    private OnAndExoplayerStateListener mOnAndExoplayerStateListener;
    public interface OnAndExoplayerStateListener {
       void onAndExoplayerState(Context context);
    }
    public void setOnExoplayerStateListener(OnAndExoplayerStateListener mListener) {

        mOnAndExoplayerStateListener = mListener;
    ...
    private void initializePlayer() {
        ...
        if (simpleExoPlayer == null) {
            ...
            bandwidthMeter = new DefaultBandwidthMeter.Builder(context).setInitialBitrateEstimate(defaultMaxInitialBitrate) .build();
